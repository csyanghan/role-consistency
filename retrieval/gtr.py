...
from retrieval.kv_store import TextType

class GTR(KVStore):
    def __init__(self, index_name: str, model_path: str = "gtr-t5-large"):
        super().__init__(index_name, 'gtr')
        self.model_path = model_path
        self._model = sentence_transformers.SentenceTransformer(model_path, device="cuda")
    ...
    def load(self, path: str):
        super().load(path)
        self._model = sentence_transformers.SentenceTransformer(self.model_path, device="cuda")
        return self
