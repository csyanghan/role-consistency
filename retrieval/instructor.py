...
class Instructor(KVStore):
    def __init__(self, index_name: str, key_instruction: str, query_instruction: str, model_path: str = "instructor-xl"):
        super().__init__(index_name, 'instructor')
        self.model_path = model_path
        self.key_instruction = key_instruction
        self.query_instruction = query_instruction
        self._model = INSTRUCTOR(model_path, device="cuda:0")
    ...
    def load(self, path: str):
        super().load(path)
        self._model = INSTRUCTOR(self.model_path, device="cuda:0")
        return self
